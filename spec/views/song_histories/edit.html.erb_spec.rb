...
RSpec.describe "song_histories/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit song_history form" do
    render

    assert_select "form[action=?][method=?]", song_history_path(@song_history), "post" do
